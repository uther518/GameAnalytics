...
class CHttpSqs
{
        ...
        public static  function getInstance( $host='127.0.0.1', $port=1218, $auth='', $charset='utf-8' )
        {
        	if( self::$instance == null )
        	{
        		self::$instance = new CHttpSqs( $host , $port, $auth , $charset );
        	}
        ...
        protected  function __construct( $host , $port, $auth , $charset )
        {
    ...
    public function http_post($query, $body)
    {
        ...
        $out = "POST {$this->httpsqs_host} HTTP/1.1\r\n";
        $out .= "Host:{$this->httpsqs_host}\r\n";
