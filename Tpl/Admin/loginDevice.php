...
$(function () {
        ...
        $('#newPlayerCode-chart').highcharts({
           ...
           */
            ...
            xAxis:<?php echo json_encode( $showData['loginDevice']['xAxis'] );?>,
            series:<?php echo json_encode( $showData['loginDevice']['series'] ); ?> 
         });
    });
			...
			<div class="textbox">
				<div role="tabbar" class="box_top">
					...
					<div id="sumAvgMd" class="info r">
	                	 总设备数：<font id="newPlayerCode-sum"><?php echo $showData['loginDeviceTotal'];?></font>&nbsp;&nbsp;
	                	 平均设备数：<font id="newPlayerCode-avg"><?php echo $showData['loginDeviceAvg'];?></font>&nbsp;&nbsp;   
	                	 最大设备数：<font id="newPlayerCode-md"><?php echo $showData['loginDeviceMax'];?></font>
	                </div>
				</div>
				...
				<div id="newPlayerCode-table" style="display: none;">
					...
					<thead>
						<tr>
							...
							<?php 
								foreach ( $showData['loginDevice']['series'] as $series )
								{
							?>
					...
					<tbody>
					<?php 
						foreach ( $showData['loginDevice']['xAxis']['categories'] as $key => $date )
						{
					?>		
					<tr class="odd">
