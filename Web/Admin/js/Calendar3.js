...
function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	...
	this.colors = {"bg_cur_day":"#00CC33","bg_over":"#EBF0F3","bg_out":"#FFCC00"}
};
...
__ci.document.writeln('th.theader {font-weight:normal;background-color:#7A889B;color:#FFFFFF;width:24px;}');
